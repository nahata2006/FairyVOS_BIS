...
#else
        void* pFrameDrawer, void* pMapDrawer,
#endif
        Atlas* pAtlas, KeyFrameDatabase* pKFDB, const std::string &strSettingPath, const int sensor, Settings* settings, const std::string &_nameSeq=std::string());
